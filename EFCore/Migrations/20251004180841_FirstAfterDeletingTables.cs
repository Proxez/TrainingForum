...
{
    /// <inheritdoc />
    public partial class FirstAfterDeletingTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResolveAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_SubCategoryId_CreatedAt",
                table: "Posts",
                columns: new[] { "SubCategoryId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reactions_UserId_TargetType_TargetId_Type",
                table: "Reactions",
                columns: new[] { "UserId", "TargetType", "TargetId", "Type" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubCategories_CategoryId_Title",
                table: "SubCategories",
